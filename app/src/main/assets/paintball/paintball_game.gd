...
const PAINTBALL_ZOOM_SFX := preload("res://global/audio/paintball_zoom.wav")
const PAINTBALL_SHOOT_SFX := preload("res://global/audio/paintball_shot.wav")
const PAINTBALL_FLY_SFX := preload("res://global/audio/paintball_fly.wav")
const PAINTBALL_HIT_SFX := preload("res://global/audio/paintball_hit.wav")
