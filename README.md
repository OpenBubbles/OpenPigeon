...
## Contributing
Git clone with Submodules. Open in Android Studio. Install to your device.

Enable developer mode in OpenBubbles -> Developer Tools. Then, add the service name: `com.openbubbles.openpigeon.MadridExtensionService`
